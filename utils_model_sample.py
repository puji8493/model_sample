...
country_1 = Countries.objects.get(name='Netherlands')
country_2 = Countries.objects.get(name='France')
country_3 = Countries.objects.get(name='England')
country_4 = Countries.objects.get(name='spain')

Sects.objects.all().delete()
...
author_1 = Authors.objects.create(name='ピカソ', age=91, fly_level=5,country=country_4)
author_1.sect.add(sect_3)

author_2 = Authors.objects.create(name='ドガ', age=83, fly_level=5,country=country_2)
author_2.sect.add(Sects.objects.get(name='naturalistic'))

author_3 = Authors.objects.create(name='モネ', age=83, fly_level=3,country=country_2)
author_2.sect.add(Sects.objects.get(name='naturalistic'))

works_1 = Works.objects.create(
    title='ゲルニカ',
    sect=Sects.objects.get(name="cubisme"),
    author=Authors.objects.get(name="ピカソ")
)
...
works_3 = Works.objects.create(
    ...
    author=Authors.objects.get(name="ドガ")
)
...
if sect:
    works_4 = Works.objects.create(
        title='睡蓮',
        sect=sect,
        author=Authors.objects.get(name="モネ")
    )
else:
